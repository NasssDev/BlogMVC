...
<div class="blog-slider blog-sider-one" style="margin-right: unset;">
        ...
        ?>
            <div class="blog-slider__item swiper-slide">
                ...
                <div class="blog-slider__content">
                    <span class="blog-slider__code"><?= $article->getPubdate() ?> by @<?= $article->getAuthor() ?> <a id='login_bt' style='text-decoration:none;' href='/api'>HOME</a></span>
        ...
        ?>
            <div class="oneComment">
                <div class="parent_comment">
                    ...
                    <!-- btn de suppression -->
                    <?php
                    if ($logStatut === true && $username === $comment->getAuthor()) {
                ...
                ?>
                        <div class="child_comment">
                            ...
                            <!--  btn de supression -->
                            <?php
                            if ($logStatut === true && $username === $childComment->getAuthor()) {
